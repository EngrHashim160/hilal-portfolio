...
const gallery = {
  ...
  images: [
    ...
    {
      src: "/work/make-master-flow-stripe.png",
      alt: "Make.com Stripe event router orchestrating subscription lifecycles across Airtable, AWeber and SuiteDash",
      orientation: "horizontal",
    },
    {
      src: "/work/make-ppd-subscription.png",
      alt: "Make.com subscription management scenario with nested routers and Airtable",
      orientation: "horizontal",
    },
    {
      src: "/work/make-aweber-engagement-tracking.png",
      alt: "Make.com AWeber engagement tracking with three-way router",
      orientation: "horizontal",
    },
    {
      src: "/work/make-suitedash-api-metadata.png",
      alt: "Make.com SuiteDash to Stripe customer metadata sync scenario",
      orientation: "horizontal",
    },
    {
      src: "/work/make-pet-profile-report.png",
      alt: "Make.com pet profile report generator parsing data into Airtable",
      orientation: "horizontal",
    },
    {
      src: "/work/make-pagefly-shopify-blog.png",
      alt: "Make.com Tally form to Shopify blog article publishing scenario",
      orientation: "horizontal",
    },
  ],
};
